...
<!-- 分配角色的对话框 -->
        <el-dialog
            title="提示" :visible.sync="setRoleDialogVisible"
    ...
    export default {
        data() {
            ...
            var checkMobile = (rule, value, cb) => {
                const regMobile = /^1(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/
            ...
            return {
                ...
                addFormRules: {
                    ...
                    email:[
                        ...
                        { min: 6, max: 25, message: '邮箱的长度在6~25个字符之间', trigger: 'blur' },
